...
std::set<std::pair<int, int>> SortStationsByDistance(std::set<std::pair<int, int>>,const std::vector<std::pair<int, int>> firstStation,const std::vector<std::pair<int, int>> lastStation);
